        ...
        <Container className='homeContainer' maxW={'5xl'} rounded={'90px'}>
          <Stack
            ...
            <Text color={'gray.100'} className='descText' fontFamily={"SF Atarian System Extended"}>
              Learn the ABC in <Text as={'span'} color='yellow.200'>Sign Language</Text> with Machine Learning!
            </Text>
            <Stack direction={{ base: 'column', md: 'row' }} spacing={10} align={'center'} alignSelf={'center'}>
              <Link to="/menu">
                <Button
            ...
            <Stack direction={{ base: 'column', md: 'row' }} spacing={10} align={'center'} alignSelf={'center'} position={'relative'}>
              <Button
                fontFamily={'SF Atarian System Extended Italic'}
                rounded={'full'}
                bg={'blue.400'}
              ...
              <Link to="my">
                <Button rounded={'full'} fontFamily={'SF Atarian System Extended Italic'}>
                  Malay
                </Button>
              </Link>
            </Stack>
