...
export function MenuEng() {
  ...
  return(
    ...
    <div
      ...
      <Container centerContent py={8} maxW='4xl'>
        <Box textAlign="center" fontSize="xl" mb={10}>
          <Heading 
            ...
            >
            Welcome to the Sign Language Learning Portal!
          </Heading>
          <Text 
            fontSize="xl" 
            ...
            >
            Choose a level to start learning or testing your skills:
          </Text>
        </Box>
